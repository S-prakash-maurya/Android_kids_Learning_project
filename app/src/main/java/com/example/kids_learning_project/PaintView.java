...
public class PaintView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (Draw draw : paths) {
            ...
            sPaint.setColor(draw.color); // WRONG
            sPaint.setStrokeWidth(draw.strokeWidth);
            sPaint.setMaskFilter(null);

            mCanvas.drawPath(draw.path,sPaint);
